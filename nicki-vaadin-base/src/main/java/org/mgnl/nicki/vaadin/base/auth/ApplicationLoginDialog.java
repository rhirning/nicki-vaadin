...
public class ApplicationLoginDialog extends NickiDialog {
	...
	public ApplicationLoginDialog() {
		...
		buttonLogin.addClickListener(event ->  {
				count++;
				if (count > MAX_COUNT) {
					Notification.show(I18n.getText("nicki.application.error.too.many.attempts"), 2000, Position.MIDDLE);
					return;
				}
				if (getApplication().login(StringUtils.stripToEmpty(getUsername()), StringUtils.stripToEmpty(getPassword()))) {
					...
					Notification.show(I18n.getText("nicki.application.error.invalid.credentials"), 2000, Position.MIDDLE);
				}
		});
	...
	private VerticalLayout buildMainLayout() {
		...
		mainLayout.add(horizontalLayout_2);
		
		// horizontalLayout_3
		horizontalLayout_3 = buildHorizontalLayout_3();
		mainLayout.add(horizontalLayout_3);
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		horizontalLayout_1.setFlexGrow(1.0f, username);
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		horizontalLayout_2.setFlexGrow(1.0f, password);
